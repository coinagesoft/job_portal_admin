    ...
    <div className="revenue-page">
      ...
      <style jsx>{`
        ...
        .revenue-filter-bar {
          ...
          box-shadow: 0 7px 20px rgba(34, 59, 115, 0.04);
        }
        .filter-title {
          display: grid;
          gap: 3px;
        ...
        .date-field:focus-within {
          border-color: #ef9600;
          box-shadow: 0 0 0 3px rgba(239, 150, 0, 0.12);
        }
        .date-field-icon {
          color: #8592aa;
          flex-shrink: 0;
        ...
        .period-switch button.active {
          background: #fff;
          color: #ef9600;
          box-shadow: 0 2px 5px rgba(35, 59, 106, 0.1);
        }
        .revenue-cards {
          display: grid;
        ...
        .revenue-card {
          ...
          box-shadow: 0 6px 18px rgba(34, 59, 115, 0.035);
        }
        .revenue-icon {
          width: 42px;
          height: 42px;
        ...
        .country-progress i {
          ...
          background: linear-gradient(90deg, #ffb538, #ff9900);
        }
        .country-row > strong {
          text-align: right;
          font-size: 12px;
        ...
        .period-panel {
          padding: 23px;
          background: linear-gradient(145deg, #233c78, #172b60);
          color: #fff;
        }
        .period-panel > span {
          color: #c9d5f1;
        ...
        .revenue-composition i.candidate {
          background: #49c3a2;
        }
        .revenue-composition i.recruiter {
          background: #ffc151;
        }
        .revenue-composition i.credits {
          background: #9b7bdd;
        }
        .revenue-composition b {
          margin-left: auto;
          color: #fff;
        }
        .transactions-panel {
