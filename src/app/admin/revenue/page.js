...
import { BriefcaseBusiness, ChartNoAxesCombined, Coins, Download, FileText, Search, Users } from 'lucide-react';
...
export default function RevenuePage() {
  ...
  ), [transactionType, country, search]);
  ...
  return (
    <div className="revenue-page">
      ...
      <section className="transactions-panel">
        <div className="transactions-top"><div><h4>Plan transactions</h4><p>Every completed membership and credit-plan payment.</p></div><label className="transaction-search"><Search size={16} /><input value={search} onChange={(event) => changeSearch(event.target.value)} placeholder="Search transaction or invoice" /></label></div>
