    ...
    <div className="revenue-page">
      ...
      <div className="revenue-insights">
        <section className="country-panel">
          <div className="panel-heading"><div><h4>Revenue by country</h4><p>{timePeriod === 'monthly' ? 'Current month' : 'Current year'} revenue performance</p></div><strong>₹{loading ? '—' : totals.toLocaleString()}</strong></div>
