...
export default function LegalContentPage() {
  ...
  useEffect(() => {
    if (editor && !editor.isDestroyed) {
      editor.commands.setContent(docs[activeTab].html, { emitUpdate: false })
    }
        ...
        <div className="panel-white" style={{ padding: '16px 20px' }}>
          <div className="d-flex align-items-center justify-content-between" style={{ flexWrap: 'wrap', gap: '12px' }}>
            ...
            <span className="font-xs" style={{
              ...
              {isDirty ? 'You have unsaved changes' : 'This page is up to date'}
            </span>
            ...
            <div className="d-flex" style={{ gap: '10px', flexShrink: 0 }}>
              <button
                ...
                style={{
                  ...
                  opacity: isDirty ? 1 : 0.5, cursor: isDirty ? 'pointer' : 'not-allowed',
                }}
              >
                Discard Changes
              </button>
