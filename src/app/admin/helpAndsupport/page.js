...
export default function AdminSupportPage() {
  ...
  const filteredTickets = useMemo(() => {
    return allTickets.filter((ticket) => {
      ...
      const expectedType = activeTab === 'candidates' ? 'Candidate' : 'Recruiter';
      if (ticket.raisedByType !== expectedType) return false;
    ...
    <>
      ...
      <div className="section-box">
        <div className="panel-white support-panel">
          ...
          <div className="box-padding support-table-wrap" style={{ position: 'relative' }}>
            {loading ? (
