...
export default function SettingsPage() {
  ...
  const saveSettings = () => setUnsaved(false)
      ...
      <div className="settings-page">
        ...
        <div className="settings-options">
          <article className="setting-card">
            ...
            <select id="default-language" className="form-control" value={language} onChange={(event) => { setLanguage(event.target.value); setUnsaved(true) }}>
          ...
          <article className="setting-card">
            ...
            <select id="session-timeout" className="form-control" value={sessionTimeout} onChange={(event) => { setSessionTimeout(event.target.value); setUnsaved(true) }}>
        ...
        <div className="settings-actions">
          <p>{unsaved ? 'Review and save your changes.' : 'Your settings are up to date.'}</p>
          <button className="btn btn-primary hover-up" type="button" onClick={saveSettings} disabled={!unsaved}>
